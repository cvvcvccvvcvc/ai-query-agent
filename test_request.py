...
que = 'В каком году Университет ИТМО был включён в число Национальных исследовательских университетов России?\n1. 2007\n2. 2009\n3. 2011\n4. 2015'

url = "http://127.0.0.1:8000/api/request" #"http://127.0.0.1:8000/api/request" #"http://158.160.137.90:8080/api/request"
...
# Используем json= для правильной сериализации и установки заголовков
